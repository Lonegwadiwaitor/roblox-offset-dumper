...
LUAU_NOINLINE std::pair<uint16_t, Compiler::TimeTrace::ThreadContext&> createScopeData(const char* name, const char* category);
...
#define LUAU_TIMETRACE_SCOPE(name, category) \
    static auto lttScopeStatic = Compiler::TimeTrace::createScopeData(name, category); \
    Compiler::TimeTrace::Scope lttScope(lttScopeStatic.second, lttScopeStatic.first)
...
#define LUAU_TIMETRACE_OPTIONAL_TAIL_SCOPE(name, category, microsec) \
    static auto lttScopeStaticOptTail = Compiler::TimeTrace::createScopeData(name, category); \
    Compiler::TimeTrace::OptionalTailScope lttScope(lttScopeStaticOptTail.second, lttScopeStaticOptTail.first, microsec)
