...
#define LUAU_ASSERT(expr) ((void)(!!(expr) || (Compiler::assertCallHandler(#expr, __FILE__, __LINE__, __FUNCTION__) && (LUAU_DEBUGBREAK(), 0))))
...
#define LUAU_FASTFLAG(flag) \
    namespace FFlag \
    { \
    extern Compiler::FValue<bool> flag; \
    }
#define LUAU_FASTFLAGVARIABLE(flag, def) \
    namespace FFlag \
    { \
    Compiler::FValue<bool> flag(xor(#flag), def, false, nullptr); \
    }
#define LUAU_FASTINT(flag) \
    namespace FInt \
    { \
    extern Compiler::FValue<int> flag; \
    }
#define LUAU_FASTINTVARIABLE(flag, def) \
    namespace FInt \
    { \
    Compiler::FValue<int> flag(xor(#flag), def, false, nullptr); \
    }
...
#define LUAU_DYNAMIC_FASTFLAGVARIABLE(flag, def) \
    namespace DFFlag \
    { \
    Compiler::FValue<bool> flag(#flag, def, true, nullptr); \
    }
...
#define LUAU_DYNAMIC_FASTINTVARIABLE(flag, def) \
    namespace DFInt \
    { \
    Compiler::FValue<int> flag(xor(#flag), def, true, nullptr); \
    }
