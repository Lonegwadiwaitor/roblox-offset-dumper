...
// Don't have Compiler::Variant available, it's a bit of an overhead, but a plain struct is nice to use
...
template<>
struct hash<Compiler::AstName>
{
    size_t operator()(const Compiler::AstName& value) const
    {
